...
This is the readme for JMonkeuEngine, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. JMonkeuEngine) > Ok.
...
- To run the project find JMonkeuEngine.java (which will be in under src/main/java/jmonkeuengine) and right click > Run 'JMonkeuEngine'
